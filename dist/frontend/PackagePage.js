...
var PackagePage = function () {
    ...
    var downloadPackage = function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, url, link, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("http://ec2-18-191-52-162.us-east-2.compute.amazonaws.com/api/package/".concat(packageId), { responseType: 'blob' })];
                case 1:
                    response = _a.sent();
